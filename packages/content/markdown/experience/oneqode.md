...
askContext:
  ...
  - Delivery across fourteen repositories is coordinated through a purpose-built multi-agent workspace, a planner agent that sequences cross-project changes delegating to seventeen project-specific coder, reviewer, and test-writer agents, alongside nine workflow skills for planning, release readiness, and design system enforcement.
---
